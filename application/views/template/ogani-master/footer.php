<!-- Footer Section Begin -->
                ...
                <div class="col-lg-3 col-md-6 col-sm-6">
                    <div class="footer__about">
                        <div class="footer__about__logo">
                            <a href="./index.html"><img src="<?php echo base_url('images/logo-text.jpg') ?>" alt=""></a>
                        </div>
                        <ul>
                            <li><?php echo $rowcompany->alamatcompany ?></li>
                            <li>Phone: <?php echo $rowcompany->notelp ?></li>
                            <li>Email: <?php echo $rowcompany->emailcompany ?></li>
                        </ul>
                    </div>
                </div>
  ...
  <!-- Link back to Colorlib can't be removed. Template is licensed under CC BY 3.0. --></p></div>
                        <div class="footer__copyright__payment"><img src="<?php echo base_url('assets/ogani-master/') ?>img/payment-item.png" alt=""></div>
                    </div>
                </div>
            </div>
        </div>
