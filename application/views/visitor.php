...
<html>
    <head>
        ...
        <!--<script type= 'text/javascript' src="<?php //echo base_url(); ?>assets/visitor/js/jquery-1.9.1.min.js"></script>-->
        <script src="https://code.jquery.com/jquery-3.6.0.min.js" crossorigin="anonymous"></script>
        <script type= 'text/javascript' src="<?php echo base_url(); ?>assets/visitor/js/exporting.js"></script>
        <script type= 'text/javascript' src="<?php echo base_url(); ?>assets/visitor/js/highcharts.js"></script>
        <script type= 'text/javascript' src="<?php echo base_url(); ?>assets/visitor/js/jquery.tsv-0.96.min.js"></script>
    </head>
    <body>
        <div class="clear"></div>
        <div>
...
?>
            ...
            <script type="text/javascript">
                $("#chart_submit_btn").click(function (e) {
                    ...
                    $.ajax({
                        url: "<?php echo site_url('visitorcontroller/get_chart_data') ?>", //The url where the server req would we made.
                        //async: false,
