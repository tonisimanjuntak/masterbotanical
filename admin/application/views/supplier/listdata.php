    ...
    <div class="col-md-12">
      <div class="card" id="cardcontent">
        <div class="card-header">
          ...
          <a href="<?php echo (site_url('supplier/tambah')) ?>" class="btn btn-sm btn-success float-right"><i class="fa fa-plus-circle"></i> Tambah Data</a>
        </div>
        <div class="card-body">
          <div class="row">
            <div class="col-md-12">
                ...
                <table class="table table-bordered table-striped table-condesed" id="table">
                  <thead>
                     <tr class="bg-success" style="">
                      ...
                      <th style="width: 15%; text-align: center;">NAMA SUPPLIER</th>
