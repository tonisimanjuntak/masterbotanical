    ...
    <div class="col-md-12">
      <div class="card" id="cardcontent">
        <div class="card-header">
          <h5 class="card-title">List Data Konsultasi</h5>
        </div>
        <div class="card-body">
          <div class="row">
            <div class="col-md-12">
                ...
                <table class="table table-bordered table-striped table-condesed" id="table">
                  <thead>
                     <tr class="bg-success" style="">
                      ...
                      <th style="width: 15%; text-align: center;">TGL KONSULTASI</th>
                      <th style="text-align: center;">NAMA KONSUMEN</th>
                      <th style="text-align: center;">EMAIL KONSUMEN</th>
...
<script type="text/javascript">
  ...
  $(document).ready(function() {
    ...
    table = $("#table").DataTable({
        ...
        "order": [],
         "ajax": {
            "url": "<?php echo site_url('consultation/datatablesource') ?>",
            "type": "POST"
        },
        "columnDefs": [
