          ...
          <div class="col-md-12">
            <div class="card" id="cardcontent">
              <div class="card-header">
                ...
                <a href="<?php echo(site_url('gallery/tambah')) ?>" class="btn btn-sm btn-success float-right"><i class="fa fa-plus-circle"></i> Tambah Data</a>
              </div>
              <div class="card-body">
                              ...
                              <div class="card-body">
                                <div class="row">
                                  <div class="col-md-12 p-1 text-center">
                                    <img src="<?php echo $filegallery ?>" alt="" style="width: 80%; height: 100px;">                                    
                                  </div>
                                  <div class="col-12 text-center">
                                    <strong><?php echo $row->judulgambar ?></strong>
                                  </div>
                                  <div class="col-12 text-center" style="height: 40px; max-height: 40px;">
                                    <a href="<?php echo base_url('../uploads/gallery/'.$row->filegallery) ?>" target="_blank"><?php echo $filegallery_text ?></a>
                                  </div>
                                  <div class="col-12 text-center mt-2">
                                    <input type="checkbox" <?php echo $checked ?> class="chktampil" data-toggle="toggle" data-on="Tampil Di Front" data-off="Tidak Tampil Di Front" data-onstyle="success" data-offstyle="default" data-id="<?php echo $row->idgallery ?>">                                    
                                  </div>
...
<script type="text/javascript">
  ...
  $('.chktampil').change(function() {
    ...
    $.ajax({
        ...
        type: 'POST',
        dataType: 'json',
        data: {'idgallery': idgallery, 'tampildifront': tampildifront},
      })
