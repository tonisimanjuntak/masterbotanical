  ...
  <div class="row" id="toni-breadcrumb">
    ...
    <div class="col-6">
      <ol class="breadcrumb float-sm-right">
        <li class="breadcrumb-item active">Dashboard Visitor</li>
      </ol>
                  ...
                  <div class="card-body">
                    <div class="d-flex">
                      <p class="d-flex flex-column">
                        <span class="text-bold text-lg" id="totalhit">0</span>
                        <span>Hit Counter Bulan <?php echo bulan(date('m')) ?></span>
                      </p>
              ...
              <div class="col-6">
                <div class="card">
                  ...
                  <div class="card-body">
                    <div class="d-flex">
                      <p class="d-flex flex-column">
                        <span class="text-bold text-lg" id="totalnewvisitor">0</span>
                        <span>New Visitor Bulan <?php echo bulan(date('m')) ?></span>
                      </p>
                    </div>
