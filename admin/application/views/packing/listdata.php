    ...
    <div class="col-md-12">
      <div class="card" id="cardcontent">
        <div class="card-header">
          <h5 class="card-title">List Data Packing</h5>
        </div>
        <div class="card-body">
          <div class="row">
            <div class="col-md-12">
                ...
                <table class="table table-bordered table-striped table-condesed" id="table">
                  <thead>
                    <tr class="bg-success" style="">
                      ...
                      <th style="text-align: center;">ID LABORATORIUM<br>TANGGAL</th>
                      <th style="text-align: left;">NAMA PRODUK</th>
                      <th style="text-align: center;">BERAT BRUTO/<br>BERAT NETTO</th>
                      <th style="text-align: center;">ID PACKING/ <br>TANGGAL</th>
...
<script type="text/javascript">
  ...
  $(document).ready(function() {
    ...
    table = $("#table").DataTable({
        ...
        "order": [],
         "ajax": {
            "url": "<?php echo site_url('packing/datatablesource') ?>",
            "type": "POST"
        },
        "columnDefs": [
