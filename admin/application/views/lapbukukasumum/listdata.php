...
?>
  ...
  <div class="row" id="toni-breadcrumb">
    <div class="col-6">
        <h4 class="text-dark mt-2">Laporan Buku Kas Umum</h4>
    </div>
    <div class="col-6">
    ...
    <div class="col-md-12">
      <div class="card" id="cardcontent">
        <div class="card-body p-5" >
          ...
          <form action="<?php echo (site_url('lapbukukasumum/cetak')) ?>" method="post">
            <div class="row">
...
<script>
  ...
  function cetak(jeniscetakan)
  {
        ...
        if (jeniscetakan=='pdf') {
          window.open("<?php echo site_url('lapbukukasumum/cetak/pdf/') ?>" + tglawal + "/" + tglakhir );          
        }else{
          window.open("<?php echo site_url('lapbukukasumum/cetak/excel/') ?>" + tglawal + "/" + tglakhir );          
        }
  }
</script>
