...
?>
  ...
  <div class="row" id="toni-breadcrumb">
    <div class="col-6">
        <h4 class="text-dark mt-2">Laporan Pengeluaran Umum</h4>
    </div>
    <div class="col-6">
      <ol class="breadcrumb float-sm-right">
        <li class="breadcrumb-item"><a href="<?php echo (site_url()) ?>">Home</a></li>
        <li class="breadcrumb-item active">Laporan Pengeluaran Umum</li>
      </ol>
    ...
    <div class="col-md-12">
      <div class="card" id="cardcontent">
        <div class="card-body p-5" >
          ...
          <form action="<?php echo (site_url('lappengeluaranumum/cetak')) ?>" method="post">
            <div class="row">
                    ...
                    <div class="form-group row">
                      ...
                      <div class="col-md-8">
                        <select name="kdakun4" id="kdakun4" class="form-control select2">
                          ...
                          <?php  
                            $rsakun = $this->db->query("select * from akun4  where left(kdakun4,1)='5' order by namaakun4");
...
<script>
  ...
  function cetak(jeniscetakan)
  {
        ...
        if (jeniscetakan=='pdf') {
          window.open("<?php echo site_url('lappengeluaranumum/cetak/pdf/') ?>" + kdakun4 + "/" + tglawal + "/" + tglakhir );          
        }else{
          window.open("<?php echo site_url('lappengeluaranumum/cetak/excel/') ?>" + kdakun4 + "/" + tglawal + "/" + tglakhir );          
        }
  }
</script>
