  ...
  <div class="row" id="toni-breadcrumb">
    ...
    <div class="col-6">
      <ol class="breadcrumb float-sm-right">
        ...
        <li class="breadcrumb-item active">Produkbahan</li>
      </ol>
    ...
    <div class="col-md-12">
      <div class="card" id="cardcontent">
        <div class="card-header">
          <h5 class="card-title">List Data Produkbahan</h5>
        </div>
        <div class="card-body">
          <div class="row">
            <div class="col-md-12">
                ...
                <table class="table table-bordered table-striped table-condesed" id="table">
                  <thead>
                     <tr class="bg-success" style="">
                      ...
                      <th style="text-align: center;">KOMPOSISI PENGGUNAAN BAHAN</th>
...
<script type="text/javascript">
  ...
  $(document).ready(function() {
    ...
    table = $("#table").DataTable({ 
        ...
        "order": [], 
         "ajax": {
            "url": "<?php echo site_url('Produkbahan/datatablesource')?>",
            "type": "POST"
        },
        "columnDefs": [
