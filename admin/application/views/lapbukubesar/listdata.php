                ...
                <div class="row">
                    ...
                    <div class="form-group row">
                      ...
                      <div class="col-md-8">
                        <div class="form-check form-check-inline">
                          ...
                          <label class="form-check-label" for="optakun3">Akun 3</label>
                        </div>
                        <div class="form-check form-check-inline">
                          <input class="form-check-input optakun" type="radio" name="optradio" id="optakun4" value="4" checked="">
                          <label class="form-check-label" for="optakun4">Akun 4</label>
                        </div>                        
                      </div>
                    </div>
                  </div>
                  ...
                  <div class="col-md-12">
                    <div class="form-group row">
                      ...
                      <div class="col-md-8">
                        <select name="kdakun" id="kdakun" class="form-control select2">
...
<script>
  ...
  function cetak(jeniscetakan)
  {
        ...
        if (jeniscetakan=='pdf') {
          window.open("<?php echo site_url('lapbukubesar/cetak/pdf/') ?>" + jenisakun + "/" + kdakun + "/" + tglawal + "/" + tglakhir );          
        }else{
          window.open("<?php echo site_url('lapbukubesar/cetak/excel/') ?>" + jenisakun + "/" + kdakun + "/" + tglawal + "/" + tglakhir );          
        }
  }
  ...
  function get_akun4()
  {
      ...
      $("#kdakun").empty();
      $("#kdakun").append( new Option('Pilih nama akun', '-') );
      ...
      .done(function(rsakun) {
        ...
        if (rsakun.length>0 ) {
          ...
          $.each(rsakun, function(index, val) {
             $("#kdakun").append( new Option(rsakun[index]['kdakun4']+' - '+rsakun[index]['namaakun4'], rsakun[index]['kdakun4']) );
          });
        }
      })
      .fail(function() {
  ...
  function get_akun3()
  {
      ...
      .done(function(rsakun) {
        ...
        if (rsakun.length>0 ) {
          ...
          $.each(rsakun, function(index, val) {
             $("#kdakun").append( new Option(rsakun[index]['kdakun3']+' - '+rsakun[index]['namaakun3'], rsakun[index]['kdakun3']) );
          });
        }
      })
      .fail(function() {
