...
$table .= '
	<div style="text-align: center; font-size: 24px; background-color: #ACACAC;">
		<span style="padding-top: 10px;">BARANG MASUK REMAHAN</span>
	</div>
';
...
$rsdetail = $this->db->query("select * from v_pengadaanbahandetail where idpengadaanbahan='".$idpengadaanbahan."' and idbahan='GE001'");
